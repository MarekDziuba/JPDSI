...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2024 at 05:36 PM
...
(8, 'Mati', 'mati@vp.pl', 'Mati1', '$2y$10$7hjU1L.GVyQ9rFzSUmA0meZvaX8w56d8bfICP5W/0ertI5ZEq5IwK', '2024-06-02 07:08:23', '2024-06-10 08:57:07'),
(9, 'Maro', 'Maro@vp.pl', 'Maro1', '$2y$10$RrSg/asxVInIoVRh0m5WOutciQZyWIwi1tUF/8jPXOB9.5pno3cKe', '2024-06-02 07:08:53', '2024-06-10 05:47:53'),
(10, 'employee', 'employee@o.pl', 'employee1', '$2y$10$D/Eh/jpL5.mC/h2yWKNGse.rqa.uFloM8pGKrqcbPN1C2ph56bOwC', '2024-06-03 02:12:33', '2024-06-03 02:12:33'),
(11, 'Cylina', 'Cylina@Cylina.pl', 'Cylina2', '$2y$10$HULp656bVxoSb17bIOSenukqwWGK0tVLY3Mq73f.2V0sQ5zA8gqcC', '2024-06-03 08:27:38', '2024-06-03 08:27:38');
...
--
ALTER TABLE `user_events`
  MODIFY `Id_events` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `user_data`
  ADD CONSTRAINT `user_data_ibfk_1` FOREIGN KEY (`Id_user`) REFERENCES `role_user` (`Id_user`);
