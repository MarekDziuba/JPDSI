...
public class UserEventDAO {
	...
	public List<UserEvent> getUserEventsByUserId(int userId) {
	    return em.createQuery("SELECT ue FROM UserEvent ue WHERE ue.userData.id_user = :userId", UserEvent.class)
